...
def parse_args():
    ...
    parser.add_argument('--partition-mode', type=str, default='metis')
    ...
    args.partition_mode = args.partition_mode if args.use_admm else None
    return args
...
if __name__ == "__main__":
    ...
    np.savetxt('e.txt', edges, '%d', delimiter=' ')
    np.savetxt('n.txt', feats, '%.3f', delimiter=' ')
