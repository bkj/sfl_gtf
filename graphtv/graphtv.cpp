...
/*
    ...
    Copyright 2007 Antonin Chambolle (antonin.chambolle@polytechnique.fr),
                   J�r�me Darbon (jerome@math.ucla.edu)
    ...
    by Antonin Chambolle and J�r�me Darbon, to implement a parametric/dyadic
...
void Graph::dyadicparametricTV(float erreur)
  // ajouter pr�cision/min/max?
  // param�trique (Hochbaum)
{
	  ...
	  for (i=node_block->ScanFirst(); i; i=node_block->ScanNext())
	    if (i->alive) {
	      ...
	      if (inactivelabel[l] ||
		    ...
		    i->tr_cap = 0;
	    	i->alive = 0; // noeud d�connect� � l'avenir
		    inactivelabel[l]=1;
	      } // end if
          else {
